...
**+3.6% multi and +1.9% single with the SAME power draw and temperature.** Zero WHEA errors
throughout. Full details in [`docs/caso-real.md`](docs/caso-real.md) (PT-BR).
...
```
├── README.md (PT-BR), README.en.md, LICENSE
